...
var uFilter = [{ vendorId: 9025, productId: 67 }];
...
$(document).ready(function () {
  ...
  if (navigator.usb) {
    ...
    navigator.usb.getDevices({ filters: uFilter }).then(function (devices) {
...
function connect() {
  ...
  navigator.usb.requestDevice({ filters: uFilter }).then(function (device_) {
...
function getRfid() {
  var _device$configuration = device.configuration.interfaces[0].alternate.endpoints[0],
      endpointNumber = _device$configuration.endpointNumber,
      packetSize = _device$configuration.packetSize;


  device.transferIn(endpointNumber, packetSize).then(function (result) {
